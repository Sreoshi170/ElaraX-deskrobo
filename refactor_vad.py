...
# We want to remove all wakeRecognitionRef, wakeFallback... and scheduleWake... refs
...
# Remove startWakeFallback from processVoiceTranscriptRef and startVoiceRecordingRef block
# Wait, replacing 577 to 932 is easier.
